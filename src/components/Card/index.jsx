                        ...
                        <div class="card">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item bg-note">
                                    <h6>Note:</h6>
                                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Doloremque facere quasi voluptate dolorum quibusdam inventore. Blanditiis dolorum doloremque consequuntur impedit, possimus, vero omnis, quas voluptas temporibus et perspiciatis similique praesentium.</p>
                                </li>
                            </ul>
                        </div>
                    </div>
